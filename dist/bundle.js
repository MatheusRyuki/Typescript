...
(function (App) {
    class ProjectList extends App.Component {
        ...
        dropHandler(event) {
            ...
            App.projectState.moveProject(prjId, this.type === "ativos" ? App.ProjectStatus.Active : App.ProjectStatus.Finished);
        }
        dragLeaveHandler(_) {
            const listElements = this.element.querySelector("ul");
...
(function (App) {
    ...
    new App.ProjectList("ativos");
    new App.ProjectList("finalizados");
})(App || (App = {}));
var App;
(function (App) {
